...
func NewDiscoveryBroadcaster(config *protocol.DiscoveryConfig, serverHost string, serverPort int, serverName string) *DiscoveryBroadcaster {
...
func (db *DiscoveryBroadcaster) broadcast() error {
	...
	msg := protocol.NewDiscoveryMessage(db.serverHost, db.serverPort, db.serverName)
